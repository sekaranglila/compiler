...
boolean EndKata;
Kata	CKata, CKataP;
Kata    BEGIN, END, IF, THEN, ELSE, FOR, DO, TO, WHILE, INPUT, OUTPUT;
boolean iferror, forerror;
int CountLine; //counter line
int CountError, begincounter, endcounter, docounter, whilecounter;
...
boolean IsKataSamaInput(Kata K1, Kata K2);
/*	Mengembalikan true jika K1 = K2; dua kata dikatakan sama jika panjangnya sama dan
	urutan karakter yang menyusun kata juga sama. Sensitif terhadap uppercase dan lowercase
*/
